...
- **10 protocols** — Structured maintenance workflows invoked by saying "run Protocol N":
  ...
  10. **Codify Drift Check** — Promote a recurring drift pattern into a permanent structural check at commit time
